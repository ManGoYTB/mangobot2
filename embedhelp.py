    ...
    async def _help(self, ctx, command = None):
        ...
        if not command:
            ...
            for group in final_coms:
                ...
                if field_count == 0:
                    page += 1
                    title = "<:pp:332133471877070848>**Command list,** page {}<:pp:332133471877070848>".format(page)
                    em=discord.Embed(description=title,
                                     color=color)
                    em.set_author(name="Help Command", icon_url='http://files.gandi.ws/gandi25943/image/interrogation.png')
                    em.set_thumbnail(url='https://cdn.discordapp.com/attachments/357926498654617602/361525598319017984/direct-help.png')    			 
            ...
            if toggle == "dm":
                await self.bot.say("Look DM{}!".format(author.mention))
                for em in to_send:
            ...
            msg = "**Command Help :**<:pp:332133471877070848>"
            color = 0xffa500
